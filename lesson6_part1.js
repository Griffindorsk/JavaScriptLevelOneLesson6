...
//     basket[i] = {
//         productIndex: (k + +1),
//         productDescription: productsCatalogue[k],
//         discountedPrice: productsCatalogue[k].finalPrice(discount),
//         quantity: n,
//         itemTotalPrice: n * productsCatalogue[k].finalPrice(discount)
//     }
// }
// printTheCatalogue(basket, 'Товар в корзине');
// console.log(basket);
